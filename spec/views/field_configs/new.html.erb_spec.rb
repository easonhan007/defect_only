...
describe "field_configs/new" do
  before(:each) do
    assign(:field_config, stub_model(FieldConfig,
      :field => "MyString",
      :html_type => "MyString",
      :values => "MyText",
      :default => "MyString",
  ...
  it "renders new field_config form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => field_configs_path, :method => "post" do
